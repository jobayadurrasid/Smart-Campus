<template>
  ...
  <div class="app-container">
    ...
    <div class="schedule-management">
      ...
      <div v-if="scheduleMethod === 'individual'" class="schedule-section">
        <div class="form-row">
          <div class="form-group">
        ...
        <div v-if="searchDepartment" class="form-group">
        ...
        <!-- Academic Controls -->
        <div v-if="selectedIndividual" class="form-row">
          <div class="form-group">
        ...
        <!-- Schedule Display -->
        <div v-if="selectedIndividual" class="schedule-container">
          <div class="schedule-grid">
            ...
            <div v-for="timeSlot in timeSlots" :key="timeSlot.start" class="schedule-row">
              ...
              <div
                ...
                :key="day"
                @click="editSlot(dayIndex, timeSlot)"
                :class="[
                  'day-col',
                  {
                    editable: editMode,
              ...
              >
                <div v-if="hasIndividualClass(dayIndex, timeSlot)" class="scheduled-class">
                  ...
                  <div class="class-info">
                    Room: {{ getIndividualClass(dayIndex, timeSlot).room }}
                  </div>
                </div>
      ...
      <!-- Group Schedule View -->
      <div v-if="scheduleMethod === 'group'" class="schedule-section">
        <div class="form-row">
          <div class="form-group">
        ...
        <button 
          ...
          <div class="group-actions">
            <button 
              ...
              class="btn-view"
            >
              View/Edit Schedule for Selected ({{ selectedStudents.length }})
            </button>
          </div>
        </div>
        <div v-else-if="groupsSearched" class="no-results">
            ...
            <div v-for="timeSlot in timeSlots" :key="timeSlot.start" class="schedule-row">
              ...
              >
                <div v-if="hasGroupClass(dayIndex, timeSlot)" class="scheduled-class">
                  ...
                  <div class="class-info">
                    Room: {{ getGroupClass(dayIndex, timeSlot).room }}
                  </div>
                </div>
                <div v-else-if="editMode" class="empty-slot">
                  {{ editMode ? '+' : '' }}
    ...
    <div v-if="showEditModal" class="modal-overlay" @click.self="closeEditModal">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Room:</label>
            <input v-model="currentEdit.room" class="form-input" placeholder="Optional room number" />
          </div>
          <div class="form-group">
            <label>Day:</label>
...
watch(selectedStudents, (newVal) => {
  selectAll.value = newVal.length === groupFilteredStudents.value.length && groupFilteredStudents.value.length > 0
}, { deep: true })
...
const saveGroupSchedule = async () => {
  ...
  try {
    ...
    const transformedGroupSchedule = groupSchedule.value.map(item => ({
    ...
    showError('Failed to save group schedule: ' + (err.message || 'Unknown error'));
